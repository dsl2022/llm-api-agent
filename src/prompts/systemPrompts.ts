export function systemPrompt(fileRead:string):string{
    ...
    words should be included. please make sure the endpoint you give has to match the one you find from the JSON I gave you earlier. If you can not find any endpoint that is relevant, just answer "no endpoint is a good fit"`
}
